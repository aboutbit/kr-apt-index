  ...
  <script>
    ...
    function geocodeApts(items, sigunguNm) {
      return new Promise(function(resolveAll) {
        ...
        kakao.maps.load(function() {
          ...
          // API에서 이미 좌표가 있는 아파트는 Kakao 지오코딩 생략
    ...
    function renderTradeMap(items) {
      ...
      Object.values(aptMap).forEach(function(apt) {
        ...
        var pyeongsArr = areas.map(function(a) { return Math.round(a / 3.3058); });
        ...
        _overlayData.push({ overlay: overlay, pyeongsArr: pyeongsArr });
    ...
    function filterTradeMap(range) {
      ...
      _overlayData.forEach(function(d) {
        var visible = range === 'all' || (d.pyeongsArr || []).some(function(p) {
